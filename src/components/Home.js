        ...
        <div className="body">
          ...
          <div className="main">
            ...
            <div className="add">
              ...
              <h3>Account Number: 0939384390</h3>
            </div>
            ...
            <div className="refer">
              <div className="top">
                <h3>Refer friends & earn credits</h3>
                <p>
                  refer a friend to adash and &#8358;100 will be added to your
                  account{" "}
                </p>
              </div>
              <div className="link">
                <p>https// www.adash%wallet#ny?referral link</p>
                <section>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
